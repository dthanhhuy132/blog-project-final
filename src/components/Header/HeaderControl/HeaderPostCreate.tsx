...
const HeaderPostCreate = (props: Props) => {
  ...
  return (
    ...
    >
      <i className="fa-solid fa-file-pen text-gray-500 cursor-pointer hover:text-gray-900 text-[1.3rem] dark:text-gray-300 dark:hover:text-blue-400"></i>

      <div
        className={`absolute flex transition-all duration-300 origin-[50%_0%]
        ${
          isShowMenu
            ? "opacity-100 z-100 scale-100"
            : "!opacity-0 !z-[-1] scale-0"
        } top-[200%] left-[30%] translate-x-[-50%] z-[100] gap-5 px-3 py-3 pb-1
        after:contents-[''] after:absolute after:top-[-20px] after:left-0 after:w-[300px] after:h-[60px] 
